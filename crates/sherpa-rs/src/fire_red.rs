...
pub type FireRedRecognizerResult = super::OfflineRecognizerResult;

#[derive(Debug, Clone)]
pub struct FireRedConfig {
    pub encoder: String,
    pub decoder: String,
    pub tokens: String,
...
impl Default for FireRedConfig {
    fn default() -> Self {
        Self {
            encoder: String::new(),
            decoder: String::new(),
...
impl FireRedRecognizer {
    pub fn new(config: FireRedConfig) -> Result<Self> {
        ...
        // FireRedASR AED model config
        let fire_red_config = sherpa_rs_sys::SherpaOnnxOfflineFireRedAsrModelConfig {
    ...
    pub fn transcribe(&mut self, sample_rate: u32, samples: &[f32]) -> FireRedRecognizerResult {
        unsafe {
            ...
            let result = FireRedRecognizerResult::new(&raw_result);
...
unsafe impl Send for FireRedRecognizer {}
unsafe impl Sync for FireRedRecognizer {}

impl Drop for FireRedRecognizer {
    fn drop(&mut self) {
        unsafe {
